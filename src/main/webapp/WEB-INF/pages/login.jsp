    ...
    <div class="container" style="width: fit-content; background-color: black; border-radius: 20px; opacity: 0.5;">
        <div align="center" style="padding: 20px 150px;">
            ...
            <form action="${loginUrl}" method="POST">
                <strong>LOGIN:</strong></br><input type="text" name="j_login"></br>
                <strong>PASSWORD:</strong></br><input type="password" name="j_password"></br></br>
                <input type="submit" value="SUBMIT" class="btn btn-primary"/>
                <br>
                <c:if test="${param.error ne null}">
                    <strong style="font-size: 20px">Wrong login or password!</strong>
                </c:if>
            </form>
        </div>
    </div>
