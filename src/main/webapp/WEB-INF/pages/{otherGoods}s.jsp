...
<div class="container-fluid">
    ...
    <div class="col-md-8">
        ...
        <div  class="row">
            <c:forEach items="${goods}" var="good">
                <div class="col-md-4">
                    <div class="thumbnail">
                        <div class="caption">
                            <b style="font-size: 20px; min-height: 56px;" class="pull-left">${good.name}</b>
                            <a href="/good_${good.id}"><img src=${good.photoLink} height="450px" alt=""> </a>
                            <b style="font-size: 16px;" class="pull-right">${good.country}     ${good.price}₴</b>
                            <br>
                            <br>
                            <a href="/good_${good.id}" class="btn btn-success pull-left" name="pointer">More details <i class="fa fa-arrow-right"></i></a>
                            <c:if test="${role=='ADMIN'}">
                                <form action="delete${goodType}" method="post">
                                    <button class="btn btn-danger pull-right" name="id" value="${good.id}"><i class="fa fa-window-close"></i></button>
                                </form>
                            </c:if>
                            <c:if test="${role=='USER'}">
                                <form action="add${goodType}ToBasket">
                                    <button class="btn btn-success pull-right" name="id" value="${good.id}"><i class="fa fa-shopping-basket"></i>+</button>
                                </form>
                            </c:if>
                            <br>
                            <br>
        ...
        <c:if test="${role=='ADMIN'}">
            <div class="row" >
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#newGood">Add ${goodType}</button>
            </div>
        </c:if>
    </div>
    <c:if test="${goods.size()!=0}">
        <div class="col-md-2">
            ...
            <div id="accordion" class="panel-group">
                <br>
                <form action="${goodType}sfromCountry">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a href="#collapse-country" data-parent="#accordion" data-toggle="collapse" class="spoiler"><i class="fa fa-chevron-right"></i><b> Country</b></a>
                            </h4>
                        </div>
                ...
                <br>
                <form action="${goodType}sByPrice">
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <h4 class="panel-title">
                                <a href="#collapse-price" data-parent="#accordion" data-toggle="collapse" class="spoiler"><i class="fa fa-chevron-right"></i><b> Price</b></a>
                            </h4>
                        </div>
...
<br>
<br>
<div class="container" style="background-color: white; opacity: 0.8; width: 100%; padding: 20px; bottom: 0px;<c:if test="${goods.size()<4}">position: absolute;</c:if>">
        ...
        <div class="modal-content-contacts">
            <div class="modal-header">
                <p class="modal-title" align="center"><span
                        style="font-family: joan,serif; font-size: large; color: darkslategray; ">Add new ${goodType}</span></p>
            </div>
            <div class="modal-body">
                <form action="new${goodType}" onsubmit="valid(document.getElementById('form')); return false" name="test" id="form">
