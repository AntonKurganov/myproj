                ...
                <div class="col-md-4">
                    <div class="thumbnail">
                        <div class="caption">
                            ...
                            <a href="/${good.kind}_${good.id}"><img src=${good.photoLink} height="450px" alt=""> </a>
                            <b style="font-size: 16px;" class="pull-right">${good.country}     ${good.price}₴</b>
                            <br>
                            <br>
                            <a href="/${good.kind}_${good.id}" class="btn btn-success pull-left" name="pointer">More details <i class="fa fa-arrow-right"></i></a>
                            <form action="deleteFromBasket">
